		...
		<div className='home'>
			...
			<div className='story-card watch'>
				<div className='story-card__container'>
					<div className='watch__content'>
						...
						<h3 className='story-card__subtitle'>
			...
			<div className='download'>
				<div className='download__container'>
					<div className='download__media'>
						<img
							className='download__media-image'
						...
						<div className='download__img-container'>
							<div className='download__image-wrapper'>
								<img
									...
									src='imgs/stranger_things.png'
									alt='stranger things'
								/>
								<div className='download__description'>
									<h3 className='download__img-title'>
										Stranger things
									</h3>
									<p className='download__img-subtitle'>
										Downloading...
									</p>
								</div>
							</div>
							<img
								className='download__download-icon'
								src='imgs/download-icon.gif'
								alt='download icon'
							/>
						</div>
					</div>
					<div className='download__text'>
						...
						<h3 className='download__subtitle'>
			...
			<div className='everywhere'>
				<div className='everywhere__container'>
					...
					<h3 className='everywhere__subtitle'>
			...
			<div className='kids'>
				<div className='kids__container'>
					...
					<div className='kids__text'>
						<h1 className='kids__title'>
							Create profiles for kids.
						</h1>
						<h3 className='kids__subtitle'>
